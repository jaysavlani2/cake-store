      ...
      <div className="text-gray-700 bg-gray-100 mt-8 md:mt-16 lg-mt-16 mx-auto px-4 md:px-0 flex-grow h-full w-full">
        <div className="lg:mx-56">
          {showSettings ? (
            ...
            <div className="grid place-items-center pt-4 mt-10 md:mt-2 lg:mt-2 mb-8">
              <div className="w-full md:w-3/4 lg:w-1/2 shadow-lg overflow-hidden roundded-none">
                ...
                <div className="border-t border-gray-200">
                  <dl>
                    ...
                    <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                      ...
                      <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <Button disabled={isSending} onClick={resetPassword} style={{ borderRadius: "0px" }}>
                          {isSending ? (
